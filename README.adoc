...
So, you can call methods / functions that return the result or the errors you got.

    public Result doSomething(...params)

Here are some tests explaining the use of Result:

[source,java]
.ResultTests.groovy
----
include::https://raw.githubusercontent.com/osoco/monkfish/master/src/test/java/es/osoco/monkfish/ResultTests.java[]
----
